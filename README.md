...
Приложение помогает разобраться в сложных кредитных документах: от выделения ключевых рисков до сравнения нескольких предложений. Всё на основе российского законодательства — ФЗ №353, ГК РФ, нормативов ЦБ.

🔗 **ссылка на сайт:** https://hackathonapp-rho.vercel.app/ — попробуйте прямо сейчас!

🔗 **ссылка на видео-визитку сайта(работа ии-ассистента в нём показана в устаревшем варианте, сейчас его работа корректно исполняется):** https://drive.google.com/file/d/1kQixFyC4lPy607HSbbViRFvQjye8pVDz/view?usp=sharing
...
│   ├── index.css            # Глобальный сброс стилей (box-sizing, overflow, scrollbar)
